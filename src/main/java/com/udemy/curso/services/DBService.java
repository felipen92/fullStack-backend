...
import com.udemy.curso.domain.Pagamento;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat4 = new Categoria(null, "Mesa Cama e Banho");
		Categoria cat5 = new Categoria(null, "Jardinagem");
		Categoria cat6 = new Categoria(null, "Decoração");
		Categoria cat7 = new Categoria(null, "Perfumaria");
		Categoria cat8 = new Categoria(null, "Programação");
		...
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "25879512", cli1, c2);
		...
		pagRepo.saveAll(Arrays.asList(pagt1, pagt2));
